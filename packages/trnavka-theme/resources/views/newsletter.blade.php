...
@php
    ...
    $header_description = 'V Saleziánskom stredisku Trnavka sa neustále niečo deje. Ak chcete byť v obraze, prihláste sa na odber našich noviniek a my vám budeme pravidelne posielať informácie o dianí u nás.';
